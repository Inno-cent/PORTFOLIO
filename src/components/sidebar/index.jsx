        ...
        <div className="sidebar">
            <div className="sidebar--innerwrapper">
                <Link href="/" className="sidebar__logo">
                    <figure>
                        <Image src="/innocent.png" alt="innocent" width={50} height={50} />
                    </figure>
                ...
                <div className="sidebar__lower-nav">
                    <ul>
                        <li>
                            <Link href="https://x.com/codesbycent" target="_blank" rel="noopener noreferrer">
                                <FaTwitter />
                        ...
                        <li>
                            <Link href="https://github.com/Inno-cent" target="_blank" rel="noopener noreferrer">
                                <FaGithub />
                        ...
                        <li>
                            <Link href="https://www.linkedin.com/in/ekweozor-innocent-026336223/" target="_blank" rel="noopener noreferrer">
                                <FaLinkedin />
