    ...
    return(
        <DashboardLayout>
            ...
            <div className="home__top">
                ...
                <div className="client--projects-wrapper">
                    <ProjectCard 
                        projectImage="/SmartPlanX.png"
                        projectTitle="SmartPlanX"
                        projectDescription="SmartScheduler helps you manage time with clarity, reminders, and simplicity"
                        alt="SmartPlanX"
                        projectYear="2025"
                        link='https://smartplanx.netlify.app/'
                    />
                    <ProjectCard 
